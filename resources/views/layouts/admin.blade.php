                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{route('permissionHandle')}}">
                                    ...
                                    <span class="{{ request()->is('admin') ? 'active' : '' }}" data-key="t-dashboard">Trang chủ</span>
                                </a>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li>
                                        <a class="{{ request()->is('admin') ? 'active' : '' }}" href="{{route('admin.surveys.create')}}">
                            ...
                            <li>
                                <a href="{{route('admin.service.manager')}}">
                                    <i class="fas fa-user-friends"></i>
                            ...
                            <li>
                                <a href="{{route('admin.user.manager')}}">
                                    <i class="fas fa-network-wire"></i>
                                    <span data-key="t-pages">Quản lý nhân sự</span>
                                </a>
                            </li>
                        </ul>
                    </div>
