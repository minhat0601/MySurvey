...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Đăng nhập - Trung tâm quản lý khảo sát khách hàng</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Chào bạn</h5>
                                            <p class="text-muted mt-2">Đăng nhập đểt tiếp tục sử dụng dịch vụ</p>
                                        </div>
                                        ...
                                        <form class="custom-form mt-4 pt-2" onsubmit="event.preventDefault(); login()">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="">
                                                            <a href="{{route('auth.recovery')}}" class="text-muted">Bạn quên mật khẩu?</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="input-group auth-pass-inputgroup">
                                                    <input type="password" class="form-control" placeholder="Nhập mật khẩu của bạn" id="password" aria-label="Password" aria-describedby="password-addon">
                                        ...
                                        <div class="mt-4 pt-2 text-center">
                                            <div class="signin-other-title">
                                                <h5 class="font-size-14 mb-3 text-muted fw-medium">- Hoặc đăng nhập bằng -</h5>
                                            </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Bạn chưa có tài khoản? <a href="{{route('auth.signup')}}" class="text-primary fw-semibold"> Đăng ký ngay </a> </p>
                                        </div>
                                    </div>
