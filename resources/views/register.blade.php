...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Đăng ký - Trung tâm quản lý khảo sát khách hàng</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Tạo tài khoản miễn phí ngay bây giờ</p>
                                        </div>
                                        <div class="alert alert-danger alert-dismissible alert-label-icon label-arrow fade hide" id="alert" role="alert">
                                            <i class="mdi mdi-block-helper label-icon"></i>
                                            <div id="alertContent"></div>
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                                            </button>
                                        </div>
                                        <form class="needs-validation custom-form mt-4 pt-2" novalidate onsubmit="event.preventDefault(); signup();">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="password" class="form-control" id="re-password" placeholder="Nhập lại mật khẩu của bạn" required>    
                                            </div>
                                            <div class="mb-4">
                                                <p class="mb-0">Việc đăng ký đồng nghĩa với việc bạn đã đồng ý với <a href="#" class="text-primary">Điều khoản sử dụng</a></p>
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="mt-4 pt-2 text-center">
                                            <div class="signin-other-title">
                                                <h5 class="font-size-14 mb-3 text-muted fw-medium">- Hoặc đăng ký bằng -</h5>
                                            </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Bạn đã có tài khoản?<a href="{{route('auth.login')}}" lass="text-primary fw-semibold"> Đăng nhập </a> </p>
                                        </div>
                                    </div>
        ...
        <script>
            const signup = () =>{
                ...
                if(email && password && repassword && fullname){
                    ...
                    Notiflix.Report.failure(
                        'Đăng ký không thành công',
                        'Tất cả dữ liệu là bắt buộc, bạn vui lòng kiểm tra lại',
                        'Đã hiểu'
                    );
                }
            }
